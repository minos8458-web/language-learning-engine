...
| AC-013 | Active-Node Admission Boundary | 🟡 Architecture Clarification **RESOLVED** / Prerequisite Implementation **IMPLEMENTED — PENDING MERGE** |
...
**상태**: 🟡 Architecture Clarification **RESOLVED** / Prerequisite Implementation **IMPLEMENTED — PENDING MERGE**(2026-07-18). 검증 브랜치의 승인된 구현·fixture correction을 local main에 통합하고 독립 코드리뷰 승인을 기록했다. origin/main push 및 post-merge 확인 전이므로 **CLOSED** 또는 **PASS**로 전환하지 않는다.
